...
namespace QQBot4Sharp.Models.QQ
{
	...
	/// QQ消息事件参数
	/// </summary>
	public class MessageEventArgs : MessageBaseEventArgs
	{
		internal MessageEventArgs(BotContext botContext, MessageRecv message) : base(botContext, message)
		{
		}
		...
		public async Task<MessageRes> ReplyAsync(MessageReq message, bool setMessageIDAuto = true)
		{
			if (setMessageIDAuto)
			{
				message.MessageID = Message.ID;
			}
			return await SendUserMessageAsync(message, Message.Author.ID);
		}
	}
}
